...
export LICENSE="${INPUT_LICENSE}"
export MAN="${INPUT_MAKEMAN}"
envsubst "\$VERSION \$COMMIT \$NAME \$DESCRIPTION \$LICENSE \$OWNER \$REPOSITORY \$SERVER_URL \$EMAIL \$MAN" < /PKGBUILD.tmpl > PKGBUILD
chmod 777 PKGBUILD
